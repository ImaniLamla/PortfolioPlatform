...
*/
    ...
    return (
    <div>
        <form className='mx-auto border-2 p-9 md:p-12 w-72 md:w-96 border-[#8a9ea7] border-2 mt-36 h-auto' onSubmit={submitHandler}>
        <h3 className='pb-6 text-2xl text-center text-[#8a9ea7] font-semibold'>Sign In</h3>
        ...
        <div className='flex justify-between'>
            <button className='px-3 py-1 rounded-sm bg-[#8a9ea7] cursor-pointer text-white' type='button'>Cancel</button>
            <button className='px-3 py-1 rounded-sm bg-[#8a9ea7] cursor-pointer text-white' type='submit'>Submit</button>
        </div>
